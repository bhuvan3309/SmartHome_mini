...
while True:
	...
	elif "turn on table light" in query:
		speak("Turning on lights")
		requests.post(url=URI+"one")
	elif "turn off table light" in query:
		speak("Turning off lights")
		requests.post(url=URI+"one")
	elif "turn on living light" in query:
		speak("Turning on lights")
		requests.post(url=URI+"two")
	elif "turn off living light" in query:
		speak("Turning off lights")
		requests.post(url=URI+"two")		
